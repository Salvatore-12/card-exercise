...
public class CardRunner implements CommandLineRunner {
    ...
    public void createCards(){
        ...
        // 2)Creazione Cards Uccelli
             //Sezione Taglia Piccola
             Card cardUcceloPiccolo = new Card("https://images.unsplash.com/photo-1599481182960-c1ec9a3c1db8?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aWwlMjBwYXNzZXJvJTIwY29tdW5lfGVufDB8fDB8fHww","Il passero comune","bellissimo esemplare di passero comune",TipoAnimale.Uccello,Taglia.Piccola);
             cardDAO.save(cardUcceloPiccolo);
             //Sezione Taglia Media
             Card cardUcceloMedia = new Card("https://images.unsplash.com/photo-1583606638017-8d10ae9b3c91?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YWNxdWlsb25lJTIwbmVybyUyMHVjY2VsbG98ZW58MHx8MHx8fDA%3D","Aquilone nero","bellissimo esemplare di un aquilone nero",TipoAnimale.Uccello,Taglia.Media);
             cardDAO.save(cardUcceloMedia);
             //Sezione Taglia Piccola
             Card cardUcceloGrande = new Card("https://plus.unsplash.com/premium_photo-1664302704305-1ad71a6d84ad?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8YXF1aWxhJTIwYXJwaWF8ZW58MHx8MHx8fDA%3D","Aquila arpia","bellissimo esemplare di aquila arpia",TipoAnimale.Uccello,Taglia.Grande);
             cardDAO.save(cardUcceloGrande);
    }
}
